    ...
    <div className="about fade-in">
      <section className="about-hero fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <p className="page-subtitle fade-in" style={{ animationDelay: '0.6s' }}>
          Building the future of IoT solutions at www.aeroband.org
        </p>
      </section>
        ...
        <div className="about-grid">
          <div className="about-text fade-in" style={{ animationDelay: '1s' }}>
            ...
            <p>
              ...
              the tools they need to create innovative, high-performance IoT solutions. 
              We believe in the power of customization and developer control, especially when it comes to IoT projects like www.aeroband.org.
            </p>
            
            <h2>Our Technology</h2>
            <p>
              Built with modern technologies including React, TypeScript, and Vite, Aeroband.org offers a fast, scalable foundation for your 
              IoT projects. Our platform is designed to be developer-friendly while maintaining excellent performance and user experience for IoT applications.
            </p>
